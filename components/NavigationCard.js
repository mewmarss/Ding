...
export default function NavigationCard() {
    ...
    const activeElement = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-3 my-1 bg-dingPurple text-white md:-mx-8 px-6 md:px-8 rounded-md shadow-md shadow-gray-300';
    const nonActiveElement = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-2 my-2 hover:bg-red-500 hover:bg-opacity-20 md:-mx-4 px-6 md:px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300';
    return (
        <Card noPadding={true}>
          ...
          <Link href="" className={pathname === '/login' ? activeElement : nonActiveElement}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
