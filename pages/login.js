        ...
        <Layout hideNavigation={true}>
            ...
            <h1 className="text-6xl mb-4 text-gray-300 text-center">Login</h1>
                <Card noPadding={true}>
                    ...
                    <a href="/" className="flex gap-4 items-center justify-center p-4 border-b border-b-gray-100 hover:bg-dingPurple hover:text-white hover:border-b-dingPurple transition-all hover:scale-110">
